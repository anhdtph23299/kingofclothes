                        ...
                        <div class="card-body">
                            <div class="d-flex mb-4 align-items-start">
                                ...
                                <div class="mr-auto">
                                    ...
                                    <span>Người tạo: Do Huy</span>
                                </div>
                                <span class="badge badge-success d-sm-inline-block d-none">Hoàn thành</span>
                            </div>
                            ...
                            <div class="row mb-4">
                                <div class="col-sm-6 mb-sm-0 mb-3 d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 pt-1 font-w500 text-black">20/09/2023</p>
                                    </div>
                                </div>
                                <div class="col-sm-6 d-flex">
                                    ...
                                    <div>
                                        ...
                                        <p class="mb-0 pt-1 font-w500 text-black">30/09/2023</p>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div>Giá trị:<span class="text-black ml-1 font-w550">5%</span></div>
                                    <div>Đơn tối thiểu:<span class="text-black ml-1 font-w550">100.000 VNĐ</span></div>
                                    <div>Giá trị giảm tối đa:<span class="text-black ml-1 font-w550">5.000 VNĐ</span></div>
                                    <div>Tổng số lượng:<span class="text-black ml-1 font-w550">99</span></div>
                                    <div>Đã dùng:<span class="text-black ml-1 font-w550">89</span></div>
                                    <div>Mô tả:<span class="text-black ml-1 font-w550">Hoạt động giảm giá cho ngày lễ tết 2023</span></div>
                                </div>
